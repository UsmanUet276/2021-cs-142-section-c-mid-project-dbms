                ...
                <div class="col-md-8">
                    <div class="invoice_body">
                        ...
                        <div class="invoice_dts">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="invoice_title">Students and their Advisors</h2>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-borderless">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">AdvisorRole</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                    include ('database.php');
                                        $query = "SELECT s.Id AS StudentId, p.FirstName + ' ' + p.LastName AS StudentName, a.Id AS AdvisorId, (SELECT [Value] FROM Lookup WHERE Id = ap.Id) AS AdvisorRole
                                        FROM Student s
                                        JOIN GroupStudent gs ON s.Id = gs.StudentId
                                        JOIN Person p ON s.Id = p.Id
                                        JOIN ProjectAdvisor pa ON gs.GroupId = (SELECT GroupId FROM GroupProject WHERE ProjectId = pa.ProjectId)
                                        JOIN Advisor a ON pa.AdvisorId = a.Id
                                        JOIN Lookup ap ON pa.AdvisorRole = ap.Id AND ap.Category = 'ADVISOR_ROLE'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="user_dt_trans">
                                                    <p><?php echo $re['StudentName'];?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="user_dt_trans">
                                                    <p><?php echo $re['AdvisorId'];?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="user_dt_trans">
                                                    <p><?php echo $re['AdvisorRole'];?></p>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php }?>
