                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="ui search focus mt-30">
                                                            <div class="ui left icon input swdh11 swdh19">
                                                                <input class="prompt srch_explore" type="text" name="title" id="id[surname]" required="" maxlength="64" placeholder="Title">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="ui search focus mt-30">
                                                            <div class="ui form swdh30">
                                                                <div class="field">
                                                                    <textarea rows="3" name="des" id="id_about" required placeholder="Write a little description about project..."></textarea>
                                                                </div>
                                                            </div>
